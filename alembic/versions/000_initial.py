...
from app.domains.membership.models import MembershipTypeEnum
...
def upgrade() -> None:
    ...
    subscription_type_table = op.create_table(
        ...
        sa.Column("type", sa.Enum(MembershipTypeEnum, name="membership_type_enum"), nullable=False),
        sa.Column("price_usd", sa.Numeric(precision=10, scale=2), nullable=False),
        sa.Column("duration", sa.Integer(), nullable=False),
        sa.Column("description", sa.String(), nullable=True),
        sa.Column("is_purchasable", sa.Boolean(), nullable=False, server_default=sa.text("true"), default=True),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["membership_id"],
            ["memberships.id"],
            name=op.f("fk_user_subscriptions_membership_id_memberships"),
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["users.id"],
